    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _roleManager.CreateAsync(new IdentityRole(StaticDetails.EmployeeRole)).GetAwaiter().GetResult();
                    _roleManager.CreateAsync(new IdentityRole(StaticDetails.SupperManagerRole)).GetAwaiter().GetResult();
                ...
                if (result.Succeeded)
                {
                    ...
                    if (role == StaticDetails.EmployeeRole)
                    {
